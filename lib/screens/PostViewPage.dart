          ...
          child: SingleChildScrollView(
            child: Stack(
              children:<Widget>[
                RepaintBoundary(
                  key:_globalKey,
                  child: SharableCard(cardData: cardData)
                ),
                Container(
                    ...
                    child: Column(
                      children: <Widget>[
                         ...
                         */
                           ...
                           */                            
                            if(_viewUpdates)
                              ...cardData.messages.sublist(1,cardData.messages.length-1).map((msg)=>
                                CardMessageBox(
                                  message:cardData.messages.last,
                                  cardTemplate: cardData.cardTemplate,
                                  important:false,
                                ...
                                children:<Widget>[
                                  OutlineButton(
                                    ...
                                    child:Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: <Widget>[
                                        Icon(Icons.add_alert,size: 15,color: cardData.cardTemplate.footerTextColor),
                                        SizedBox(width: 4),
                                        Text("ADD UPDATE",style: TextStyle(fontSize: 11,color: cardData.cardTemplate.footerTextColor))
                                      ],
                                    ),
                                  ),
                                  
                                  if(_viewUpdates == false && cardData.messages.length > 2)
                                    ...[
                                      SizedBox(width: 10),
                                      OutlineButton(
                                        borderSide: BorderSide(
                                        ...
                                        child:Row(
                                          mainAxisSize: MainAxisSize.min,
                                          children: <Widget>[
                                            Icon(Icons.access_time,size: 15,color: cardData.cardTemplate.footerTextColor),
                                            SizedBox(width: 4),
                                            Text("UPDATE HISTORY",style: TextStyle(fontSize: 11,color: cardData.cardTemplate.footerTextColor))
                                          ],
                                        ),
                                      ),
                                    ]
